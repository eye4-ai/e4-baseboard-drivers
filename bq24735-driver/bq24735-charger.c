...
#define BQ24735_CHG_OPT_WATCHDOG	(0x3 << 13)
...
static inline int bq24735_enable_charging(struct bq24735 *charger)
{
	...
	dev_info(&charger->client->dev, "bq24735 : (eye4) enable charging with no watchdog");

	return bq24735_update_word(charger->client, BQ24735_CHG_OPT,
				   BQ24735_CHG_OPT_CHARGE_DISABLE | BQ24735_CHG_OPT_WATCHDOG,
				   0);
}
				 ...
				 const struct i2c_device_id *id)
{
	...
	dev_info(&client->dev, "bq24735 : (eye4/edd) Probe bq24735 driver");
	...
	dev_info(&client->dev, "bq24735 : (eye4) 1 OK");

	if (IS_ENABLED(CONFIG_OF) && !charger->pdata && client->dev.of_node) {
		dev_info(&client->dev, "bq24735 : (eye4) Load from devicetree..");
	...
	dev_info(&client->dev, "bq24735 : (eye4) 2 OK");
	...
	dev_info(&client->dev, "bq24735 : (eye4) 3 OK");
	...
	dev_info(&client->dev, "bq24735 : (eye4) 4 OK");
	...
	dev_info(&client->dev, "bq24735 : (eye4) 5 OK");
	...
	dev_info(&client->dev, "bq24735 : (eye4) 5 - Driver loaded succesuflly");
