...
make ARCH=arm64 O=$TEGRA_KERNEL_OUT modules_install INSTALL_MOD_PATH=/u00/e4-baseboard-xavier-nx-32.4.5/Linux_for_Tegra/rootfs/

cd /u00/e4-baseboard-xavier-nx-32.4.5/Linux_for_Tegra
./flash.sh kernel-dtb p3449-0000+p3668-0001-qspi-emmc mmcblk0p1
